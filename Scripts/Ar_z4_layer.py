...
#===INTERFACES BETWEEN LAYERS: ROUGHNESS (z_rms)===
#======z_rms UNIT IN REFL1D: Angstroms
#===Notation: "AB_rms" refers to the rms-roughness between layers A (bottom) and B (top).

#Si_Platinum=(Si_FracWidth)*(Platinum_Thickness)
Platinum_Water=(Platinum_FracWidth)*(T_eff0)
Water_Nafion=(Water_FracWidth)*(T_eff1)
Nafiongas_rms=Parameter(name="Nafiongas_rms",value=10.0)
...
# Platinum.rho.range(2,4.0)
# Water.rho.range(0.702,3.2)
# Nafion.rho.range(0.702,3.2)
#===INTERFACE CONSTRAINTS:
# Nafiongas_rms.range(0,25)

#===THICKNESS CONSTRAINTS:
# Platinum_Thickness.range(0,305)
# Water_Thickness.range(2,305)
# Nafion_Thickness.range(2,305)
