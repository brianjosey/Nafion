...
NUM_POINTS = 7              # Number of control points
...
sample[SiOx].material.rho.range(1.1100, 3.1100)
...
sample[SiOx].thickness.range(0.0000, 135.10)
sample[Permalloy].thickness.range(8.0000, 208.00)
sample[Platinum].thickness.range(0.0000, 148.25)
#sample[Air].thickness.range(0.0000, 100.00)

# LAYER ROUGHNESSES
sample[Silicon].interface.range(25.490, 45.490)
sample[SiOx].interface.range(0.0000, 13.559)
sample[Permalloy].interface.range(0.0000, 18.522)
