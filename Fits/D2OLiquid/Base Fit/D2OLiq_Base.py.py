...
probe = load4('R1LD2O.refl', back_reflectivity=False)
...
slds.append(SLD(name='Water-interface', rho=1.5000, irho=0.0000))
...
slds.append(SLD(name='Water-bulk', rho=6.3400, irho=0.0000))
