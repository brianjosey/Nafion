...
WRL1_thickness.range(4,45)
NRL1_thickness.range(4,45)
WRL2_thickness.range(2,45)
NRL2_thickness.range(4,45)
grad_thickness.range(4,400)


sample[WRL1].material.rho.range(0.00, 7.0)
sample[NRL1].material.rho.range(0.00, 7.0)
sample[WRL2].material.rho.range(0.00, 7.0)
sample[NRL2].material.rho.range(0.00, 7.0)
sample[grad].material.rho.range(0.00, 7.0)
...
sample[Nafion].material.rho.range(2.705, 7.0)
...
sample[Nafion].thickness.range(4, 400)
