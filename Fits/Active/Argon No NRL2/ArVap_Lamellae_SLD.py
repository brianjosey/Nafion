...
WRL2_Grad = Parameter(name='WRL2:Grad', value=0.2124)
...
Teff4 = pow( (pow(WRL2_thickness,-4.0) + pow(grad_thickness,-4.0) ),-0.25)

Teff5 = Parameter (name="Effective T6", value=1)
Teff5 = pow( (pow(grad_thickness,-4.0) + pow(Nafion_thickness,-4.0) ),-0.25) 

# Interfacial roughness
Pt_int= Pt_WRL1*Teff1
WRL1_int=WRL1_NRL1*Teff2 
NRL1_int=NRL1_WRL2*Teff3 
WRL2_int=WRL2_Grad*Teff4
grad_int=grad_bulk*Teff5 
