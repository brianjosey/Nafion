...
sld1 = SLD(name='Interface', rho=25.00, irho=3.664)
sld2 = SLD(name='SiOx', rho=33.940, irho=6.8710)
sld3 = SLD(name='Permalloy', rho=66.490, irho=0.0000)
...
layer1 = Slab(material=sld1, thickness=10.000, interface=5.0000)
layer2 = Slab(material=sld2, thickness=40.550, interface=3.2240)
layer3 = Slab(material=sld3, thickness=108.00, interface=6.7510)
...
sld1.rho.range(22.000, 27.000)
sld2.rho.range(32.940, 34.940)
sld3.rho.range(65.490, 67.490)
sld4.rho.range(132.90, 134.90)
sld5.rho.range(-1.0000, 1.0000)

## LAYER ABSORPTIONS (imaginary rho)
sld0.irho.range(-0.54200, 1.4580)
sld1.irho.range(2.5000, 3.5000)
sld2.irho.range(5.8710, 7.8710)
...
layer2.thickness.range(0.0000, 140.55)
layer3.thickness.range(8.0000, 208.00)
...
layer1.interface.range(0.0000, 15.000)
layer2.interface.range(0.0000, 13.224)
