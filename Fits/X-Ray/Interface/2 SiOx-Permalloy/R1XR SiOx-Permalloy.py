...
sld2 = SLD(name='Interface', rho=50.000, irho=3.4500)
...
layer2 = Slab(material=sld2, thickness=10.000, interface=5.0000)
...
layer2.thickness.range(0.0000, 110.00)
...
layer2.interface.range(0.0000, 15.000)
