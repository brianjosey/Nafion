...
WRL1 = SLD(name='WRL1', rho=(NAFION_SLD*WRL1_frac)+(WATER_SLD*(1-WRL1_frac)))
NRL1 = SLD(name='NRL1', rho=(NAFION_SLD*NRL1_frac)+(WATER_SLD*(1-NRL1_frac)))
WRL2 = SLD(name='WRL2', rho=(NAFION_SLD*WRL2_frac)+(WATER_SLD*(1-WRL2_frac)))
NRL2 = SLD(name='NRL2', rho=(NAFION_SLD*NRL2_frac)+(WATER_SLD*(1-NRL2_frac)))
grad = SLD(name='Gradient', rho=(NAFION_SLD*grad_frac)+(WATER_SLD*(1-grad_frac)))
bulk = SLD(name='Bulk', rho=(NAFION_SLD*bulk_frac)+(WATER_SLD*(1-bulk_frac)))
