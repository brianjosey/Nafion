...
WRL1_NRL1 = Parameter(name='WRL1_NRL1', value=0.5)
NRL1_WRL2 = Parameter(name='NRL1:WRL2', value=0.2)
WRL2_NRL2 = Parameter(name='WRL2:NRL2', value=0.5)
NRL2_Grad = Parameter(name='NRL2:Grad', value=0.2)
...
WRL1_thickness.range(4,35)
NRL1_thickness.range(4,35)
WRL2_thickness.range(4,35)
NRL2_thickness.range(4,35)
...
sample[SiOx].thickness.range(25, 125)
