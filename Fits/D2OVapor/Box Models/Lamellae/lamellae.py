...
sample = (Silicon(5000,44.84)
		...
		#|gradient(grad_thickness,grad_int)
		|Nafion(300,8.5)
        |Air)
...
NRL1_thickness.range(4,25)
WRL1_thickness.range(4,20)
NRL2_thickness.range(4,25)
WRL2_thickness.range(4,20)
...
sample[SiOx].thickness.range(25, 150)
