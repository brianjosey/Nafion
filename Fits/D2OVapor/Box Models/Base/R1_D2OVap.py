...
probe = load4('R1_D2OVap.refl', back_reflectivity=False)
...
slds.append(SLD(name='Interface', rho=2.0710, irho=0.0000))
slabs.append(slds[1](14.01, 35.490, magnetism=Magnetism(rhoM=0.0000, thetaM=0.0000)))
s.add( slabs[1])

slds.append(SLD(name='SiOx', rho=2.1100, irho=0.0000))
slabs.append(slds[2](35.100, 3.5590, magnetism=Magnetism(rhoM=0.0000, thetaM=0.0000)))
s.add( slabs[2])

slds.append(SLD(name='Permalloy', rho=9.2390, irho=0.0000))
slabs.append(slds[3](108.00, 8.5220, magnetism=Magnetism(rhoM=1.9420, thetaM=270.00)))
s.add( slabs[3])

slds.append(SLD(name='Platinum', rho=6.4460, irho=0.0000))
slabs.append(slds[4](48.250, 0.0000, magnetism=Magnetism(rhoM=0.0000, thetaM=0.0000)))
s.add( slabs[4])

slds.append(SLD(name='Water', rho=1.5000, irho=0.0000))
slabs.append(slds[5](10.000, 0.0000, magnetism=Magnetism(rhoM=0.0000, thetaM=0.0000)))
s.add( slabs[5])

slds.append(SLD(name='Nafion', rho=3.7050, irho=0.0000))
slabs.append(slds[6](286.60, 7.7020, magnetism=Magnetism(rhoM=0.0000, thetaM=0.0000)))
s.add( slabs[6])

slds.append(SLD(name='Air', rho=0.0000, irho=0.0000))
slabs.append(slds[7](0.0000, 0.0000, magnetism=Magnetism(rhoM=0.0000, thetaM=0.0000)))
s.add( slabs[7])
...
s[1].material.rho.range(1.1100, 3.1100)
s[2].material.rho.range(1.1100, 3.1100)
s[3].material.rho.range(8.2390, 10.239)
s[4].material.rho.range(5.4460, 7.4460)
s[5].material.rho.range(0.50000, 2.5000)
s[6].material.rho.range(2.7050, 4.7050)
...
s[3].magnetism.rhoM.range(0.94200, 2.9420)
#s[4].magnetism.rhoM.range(-1.0000, 1.0000)
#s[5].magnetism.rhoM.range(-1.0000, 1.0000)
#s[6].magnetism.rhoM.range(-1.0000, 1.0000)
#s[7].magnetism.rhoM.range(-1.0000, 1.0000)

# LAYER THETAMs
#s[0].magnetism.rhoM.range(-30.000, 30.000)
#s[1].magnetism.rhoM.range(-30.000, 30.000)
#s[2].magnetism.rhoM.range(-30.000, 30.000)
#s[3].magnetism.rhoM.range(240.00, 300.00)
#s[4].magnetism.rhoM.range(-30.000, 30.000)
#s[5].magnetism.rhoM.range(-30.000, 30.000)
#s[6].magnetism.rhoM.range(-30.000, 30.000)
#s[7].magnetism.rhoM.range(-30.000, 30.000)

# LAYER THICKNESSES
#s[0].thickness.range(0.0000, 100.00)
s[1].thickness.range(0.0000, 135.10)
s[2].thickness.range(0.0000, 135.10)
s[3].thickness.range(8.0000, 208.00)
s[4].thickness.range(0.0000, 148.25)
s[5].thickness.range(0.0000, 110.00)
s[6].thickness.range(186.60, 386.60)
#s[6].thickness.range(0.0000, 100.00)

# LAYER ROUGHNESSES
s[0].interface.range(25.490, 45.490)
s[1].interface.range(25.490, 45.490)
s[2].interface.range(0.0000, 13.559)
s[3].interface.range(0.0000, 18.522)
s[4].interface.range(0.0000, 10.000)
s[5].interface.range(0.0000, 10.000)
s[6].interface.range(0.0000, 17.702)
