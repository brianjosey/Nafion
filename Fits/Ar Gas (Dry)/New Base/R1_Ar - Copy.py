...
slabs.append(slds[0](0.0000, 35.490, magnetism=Magnetism(rhoM=0.0000, thetaM=270.0000)))
s.add( slabs[0])

slds.append(SLD(name='SiOx', rho=2.1100, irho=0.0000))
slabs.append(slds[1](35.100, 3.5590, magnetism=Magnetism(rhoM=0.0000, thetaM=270.0000)))
s.add( slabs[1])

slds.append(SLD(name='Permalloy', rho=9.2390, irho=-0.001))
slabs.append(slds[2](108.00, 8.5220, magnetism=Magnetism(rhoM=1.9420, thetaM=270.00)))
s.add( slabs[2])

slds.append(SLD(name='Platinum', rho=6.4460, irho=-0.002))
slabs.append(slds[3](48.250, 0.0000, magnetism=Magnetism(rhoM=0.0000, thetaM=270.0000)))
s.add( slabs[3])

slds.append(SLD(name='Water', rho=1.5000, irho=0.0000))
slabs.append(slds[4](10.000, 0.0000, magnetism=Magnetism(rhoM=0.0000, thetaM=270.0000)))
s.add( slabs[4])

slds.append(SLD(name='Nafion', rho=3.7050, irho=0.0000))
slabs.append(slds[5](286.60, 7.7020, magnetism=Magnetism(rhoM=0.0000, thetaM=270.0000)))
s.add( slabs[5])

slds.append(SLD(name='Air', rho=0.0000, irho=0.0000))
slabs.append(slds[6](0.0000, 0.0000, magnetism=Magnetism(rhoM=0.0000, thetaM=270.0000)))
s.add( slabs[6])
...
s[1].material.rho.range(2.0700, 9.0000)
s[2].material.rho.range(8.2390, 10.239)
s[3].material.rho.range(5.4460, 7.4460)
s[4].material.rho.range(0.0000, 6.0000)
...
# LAYER ROUGHNESSES
s[0].interface.range(1.0000, 50.000)
s[1].interface.range(1.0000, 25.000)
s[2].interface.range(0.0000, 18.522)
s[3].interface.range(0.0000, 30.000)
s[4].interface.range(0.0000, 30.000)
s[5].interface.range(0.0000, 17.702)
