...
sld3 = SLD(name='Platinum', rho=133.90, irho=7.4510)
sld4 = SLD(name='Interface', rho=50.000, irho=3.5000)
...
layer3 = Slab(material=sld3, thickness=49.490, interface=3.6570)
layer4 = Slab(material=sld4, thickness=10.000, interface=3.6570)
...
sld3.irho.range(6.4510, 8.4510)
sld4.irho.range(2.5000, 4.5000)
...
layer3.thickness.range(0.0000, 149.49)
layer4.thickness.range(0.0000, 110.00)
